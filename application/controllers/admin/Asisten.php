	...
	function simpan_guru(){
	            ...
	            if(!empty($_FILES['filefoto']['name']))
	            {
	                if ($this->upload->do_upload('filefoto'))
	                {
							...
							$this->m_guru->simpan_guru($nip,$nama,$jenkel,$tmp_lahir,$tgl_lahir,$wa,$email,$photo);
					...
					$this->m_guru->simpan_guru_tanpa_img($nip,$nama,$jenkel,$tmp_lahir,$tgl_lahir,$wa,$email);
					echo $this->session->set_flashdata('msg','success');
					redirect('admin/asisten');
				}
	...
	function update_guru(){
	            ...
	            if(!empty($_FILES['filefoto']['name']))
	            {
	                if ($this->upload->do_upload('filefoto'))
	                {
							...
							$this->m_guru->update_guru($kode,$nip,$nama,$jenkel,$tmp_lahir,$tgl_lahir,$wa,$email,$photo);
	                    ...
	                    redirect('admin/asisten');
                            ...
                            $wa=strip_tags($this->input->post('xwa'));
                            $email=strip_tags($this->input->post('xemail'));
							$this->m_guru->update_guru_tanpa_img($kode,$nip,$nama,$jenkel,$tmp_lahir,$tgl_lahir,$wa,$email);
							echo $this->session->set_flashdata('msg','info');
							redirect('admin/asisten');
	            } 
