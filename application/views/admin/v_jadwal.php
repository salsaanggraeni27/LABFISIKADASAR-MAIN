...
<head>
    ...
    <title>Admin | Jadwal Praktikum</title>
                    ...
                    <div class="box">
                        ...
                        <div class="box">
                            <div class="box-header">
                                <a class="btn btn-success btn-flat" data-toggle="modal" data-target="#myModal"><span class="fa fa-plus"></span> Add Jadwal</a>
                            </div>
                            <!-- /.box-header -->
                            <div class="box-body">
                                <table id="example1" class="table table-striped" style="font-size:12px;">
                                    ...
                                    foreach ($data->result_array() as $i) :
                                        $no++;
                                        $id=$i['jadwal_id'];
                                        $judul=$i['jadwal_judul'];
                                        $deskripsi=$i['jadwal_deskripsi'];
                                        $jurusan=$i['jadwal_jurusan'];
                                        $link=$i['jadwal_link'];
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Add Jadwal</h4>
            </div>
            <form class="form-horizontal" action="<?php echo base_url().'admin/jadwal/simpan_file'?>" method="post" enctype="multipart/form-data">
    ...
    <div class="modal fade" id="ModalEdit<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form class="form-horizontal" action="<?php echo base_url().'admin/jadwal/update_file'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                ...
                                <input type="hidden" name="file" value="<?php echo $link;?>">
                        ...
                        <div class="form-group">
                            <label for="inputUserName" class="col-sm-4 control-label">Jurusan</label>
                            <div class="col-sm-7">
                                <input type="text" name="xjurusan" class="form-control" value="<?php echo $jurusan;?>" id="inputUserName" placeholder="Jurusan" required>
                            </div>
                        </div>
    ...
    <div class="modal fade" id="ModalHapus<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form class="form-horizontal" action="<?php echo base_url().'admin/jadwal/hapus_file'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                        <input type="hidden" name="kode" value="<?php echo $id;?>"/>
