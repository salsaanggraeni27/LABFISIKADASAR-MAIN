...
<head>
    ...
    <title>Admin | Data Kelompok</title>
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Data Kelompok Praktikan
                <small></small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                <li class="active">Data Kelompok Praktikan</li>
            </ol>
        </section>
                    ...
                    <div class="box">
                        ...
                        <div class="box">
                            <div class="box-header">
                                <a class="btn btn-success btn-flat" data-toggle="modal" data-target="#myModal"><span class="fa fa-plus"></span> Add Kelompok</a>
                            </div>
                            <div class="col">
                            ...
                            <div class="box-body">
                                <table id="example1" class="table table-striped" style="font-size:13px;">
                                    ...
                                    foreach ($data->result_array() as $i) :
                                        ...
                                        $nis=$i['siswa_nis'];
                                        $nama=$i['siswa_nama'];
                                        $jurusan=$i['siswa_jurusan'];
                                        $kelompok=$i['siswa_kelompok'];
                                        $kelompok_besar=$i['siswa_kelompok_besar'];
                                        $kelas_siswa=$i['kelas_siswa'];
                                        $harijam_siswa=$i['harijam_siswa'];
                                        ?>
                                        <tr>
                                            <td><?php echo $nis;?></td>
                                            <td><?php echo $nama;?></td>
                                            ...
                                            <td><?php echo $kelompok_besar;?></td>
                                            <td><?php echo $kelas_siswa;?></td>
                                            <td><?php echo $harijam_siswa;?></td>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Add Data Kelompok</h4>
            </div>
            <form class="form-horizontal" action="<?php echo site_url('ImportExcel/upload_data');?>" method="post" enctype="multipart/form-data">
    ...
    <div class="modal fade" id="ModalEdit<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                    <h4 class="modal-title" id="myModalLabel">Edit asisten</h4>
                </div>
                <form class="form-horizontal" action="<?php echo base_url().'admin/siswa/update_siswa'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="text" name="xjurusan" value="<?php echo $jurusan;?>" class="form-control" id="inputUserName" placeholder="NIP" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="inputUserName" class="col-sm-4 control-label">Kelompok</label>
                            <div class="col-sm-7">
                                <input type="text" name="xkelompok" value="<?php echo $kelompok;?>" class="form-control" id="inputUserName" placeholder="NIP" required>
                            </div>
                        </div>
...
<?php elseif($this->session->flashdata('msg')=='success'):?>
    <script type="text/javascript">
        $.toast({
            heading: 'Success',
            text: "Data Kelompok Berhasil disimpan ke database.",
            showHideTransition: 'slide',
            icon: 'success',
            hideAfter: false,
            position: 'bottom-right',
...
<?php elseif($this->session->flashdata('msg')=='info'):?>
    <script type="text/javascript">
        $.toast({
            heading: 'Info',
            text: "Data Kelompok berhasil di update",
            showHideTransition: 'slide',
            icon: 'info',
            hideAfter: false,
            position: 'bottom-right',
...
<?php elseif($this->session->flashdata('msg')=='success-hapus'):?>
    <script type="text/javascript">
        $.toast({
            heading: 'Success',
            text: "Data Kelompok Berhasil dihapus.",
            showHideTransition: 'slide',
            icon: 'success',
            hideAfter: false,
            position: 'bottom-right',
