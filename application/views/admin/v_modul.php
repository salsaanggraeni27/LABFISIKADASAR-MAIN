...
<head>
    ...
    <title>Admin | Modul Praktikum</title>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Modul Praktikum</li>
            </ol>
        </section>
                    ...
                    <div class="box">
                        ...
                        <div class="box">
                            <div class="box-header">
                                <a class="btn btn-success btn-flat" data-toggle="modal" data-target="#myModal"><span class="fa fa-plus"></span> Add Modul</a>
                            </div>
                            <!-- /.box-header -->
                            <div class="box-body">
                                <table id="example1" class="table table-striped" style="font-size:12px;">
                                    ...
                                    foreach ($data->result_array() as $i) :
                                        ...
                                        $id=$i['modul_id'];
                                        $judul=$i['modul_judul'];
                                        $deskripsi=$i['modul_deskripsi'];
                                        $oleh=$i['modul_oleh'];
                                        $link=$i['modul_link'];
                                        $linkytb=$i['modul_linkytb'];
                                        $tanggal=$i['tanggal'];
                                        $download=$i['modul_download'];
                                        $file=$i['modul_data'];
                                        ?>
                                        <tr>
                                            <td><?php echo $no;?></td>
                                            <td><a href="<?php echo $link;?>"><?php echo $judul;?></a></td>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form class="form-horizontal" action="<?php echo base_url().'admin/modul/simpan_file'?>" method="post" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="inputUserName" class="col-sm-4 control-label">Link File</label>
                        <div class="col-sm-7">
                            <input type="text" name="xlink" class="form-control" id="inputUserName" placeholder="Link File" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputUserName" class="col-sm-4 control-label">Link Youtube</label>
                        <div class="col-sm-7">
                            <input type="text" name="xlinkytb" class="form-control" id="inputUserName" placeholder="Link Youtube" required>
                        </div>
                    </div>
                    <div class="form-group">
    ...
    <div class="modal fade" id="ModalEdit<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form class="form-horizontal" action="<?php echo base_url().'admin/modul/update_file'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="inputUserName" class="col-sm-4 control-label">Link Youtube</label>
                            <div class="col-sm-7">
                                <input type="text" name="xlinkytb" class="form-control" value="<?php echo $linkytb;?>" id="inputUserName" placeholder="Link" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="inputUserName" class="col-sm-4 control-label">File</label>
    ...
    <div class="modal fade" id="ModalHapus<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form class="form-horizontal" action="<?php echo base_url().'admin/modul/hapus_file'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                        <input type="hidden" name="kode" value="<?php echo $id;?>"/>
                        <input type="hidden" name="file" value="<?php echo $file;?>">
...
<?php elseif($this->session->flashdata('msg')=='success'):?>
    <script type="text/javascript">
        $.toast({
            heading: 'Success',
            text: "Modul Berhasil disimpan ke database.",
            showHideTransition: 'slide',
            icon: 'success',
            hideAfter: false,
            position: 'bottom-right',
