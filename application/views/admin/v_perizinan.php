                                ...
                                <table id="example1" class="table table-striped" style="font-size:12px;">
                                    ...
                                    foreach ($data->result() as $row) :
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="<?php echo base_url().'admin/perizinan/download/'.$row->id_perizinan;?>"><?php echo $row->surat_izin;?></a></td>
                                            ...
                                            <td style="text-align:right;">
                                                ...
                                                <?php if($row->perizinan_status=='1'):?>
                                                <a class="btn btn-hapus" href="javascript:void(0);" data-id="<?php echo $row->id_perizinan;?>" title="Hapus"><span class="fa fa-trash"></span></a>
                                                <?php elseif ($row->perizinan_status=='2'):?>
                                                <a class="btn" href="<?php echo site_url('admin/perizinan/clear/'.$row->id_perizinan);?>" title="Approve"><span class="fa fa-send"></span></a>
                                                    <a class="btn" href="<?php echo site_url('admin/perizinan/tolak/'. $row->id_perizinan);?>" title="Tolak"><span class="fa fa-close"></span></a>
                                                <?php else:?>
                                                    <a class="btn" href="<?php echo site_url('admin/perizinan/clear/'.$row->id_perizinan);?>" title="Approve"><span class="fa fa-send"></span></a>
                                                    <a class="btn" href="<?php echo site_url('admin/perizinan/tolak/'. $row->id_perizinan);?>" title="Tolak"><span class="fa fa-close"></span></a>
                                                    <a class="btn btn-hapus" href="javascript:void(0);" data-id="<?php echo $row->id_perizinan;?>" title="Hapus"><span class="fa fa-trash"></span></a>
...
<div class="modal fade" id="ModalHapus" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form class="form-horizontal" action="<?php echo base_url().'admin/perizinan/hapus'?>" method="post" enctype="multipart/form-data">
                <div class="modal-body">
                    <input type="hidden" name="kode" value=""/>
                    <p>Apakah Anda yakin mau menghapus Perizinan ini?</p>
...
<script>
    $(function () {
        ...
        $('#example1').on('click','.btn-hapus',function(){
            var perizinan_id = $(this).data('id');
            $('#ModalHapus').modal('show');
            $('[name="kode"]').val(perizinan_id);
        });
...
<script type="text/javascript">
    $.toast({
        heading: 'Success',
        text: "Perizinan Telah di Approve.",
        showHideTransition: 'slide',
        icon: 'success',
        hideAfter: false,
        position: 'bottom-right',
