                            ...
                            <div class="box-body">
                                <table id="example1" class="table table-striped" style="font-size:13px;">
                                    ...
                                    foreach ($data->result_array() as $i) :
                                        ...
                                        $id=$i['alumni_id'];
                                        $nama=$i['nama_alumni'];
                                        $jurusan=$i['jurusan_alumni'];
                                        $wa=$i['wa_alumni'];
                                        $line=$i['line_alumni'];
                                        $linkedin=$i['linkedin_alumni'];
                                        $email=$i['email_alumni'];
                                        $angkatan=$i['angkatan_alumni'];
                                        $photo=$i['foto_alumni'];
            ...
            <form class="form-horizontal" action="<?php echo base_url().'admin/alumni/simpan_alumni'?>" method="post" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input type="text" name="xjurusan" class="form-control" id="inputUserName" placeholder="Jurusan" required>
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="inputUserName" class="col-sm-4 control-label">Nomor WA</label>
                        <div class="col-sm-7">
                            <input type="text" name="xwa" class="form-control" id="inputUserName" placeholder="Nomor WA" required>
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="inputUserName" class="col-sm-4 control-label">ID Line</label>
                        <div class="col-sm-7">
                            <input type="text" name="xline" class="form-control" id="inputUserName" placeholder="ID Line" required>
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="inputUserName" class="col-sm-4 control-label">Linkedin</label>
                        <div class="col-sm-7">
                            <input type="text" name="xlinkedin" class="form-control" id="inputUserName" placeholder="ID Linkedin" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="inputUserName" class="col-sm-4 control-label">Pesan/Kesan</label>
                        <div class="col-sm-7">
                            <input type="text" name="xpesan" class="form-control" id="inputUserName" placeholder="Pesan dan Kesan" required>
                        </div>
                    </div>
                ...
                <form class="form-horizontal" action="<?php echo base_url().'admin/alumni/update_alumni'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="inputUserName" class="col-sm-4 control-label">Nama Lengkap</label>
                            <div class="col-sm-7">
                                <input type="text" name="xnama" value="<?php echo $nama;?>" class="form-control" id="inputUserName" placeholder="Nama Lengkap" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="inputUserName" class="col-sm-4 control-label">Jurusan</label>
                            <div class="col-sm-7">
                                <input type="text" name="xjurusan" value="<?php echo $jurusan;?>" class="form-control" id="inputUserName" placeholder="Jurusan" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="inputUserName" class="col-sm-4 control-label">Nomor WA</label>
                            <div class="col-sm-7">
                                <input type="text" name="xwa" value="<?php echo $wa;?>" class="form-control" id="inputUserName" placeholder="Nomor WA" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="inputUserName" class="col-sm-4 control-label">ID Line</label>
                            <div class="col-sm-7">
                                <input type="text" name="xline" value="<?php echo $line;?>" class="form-control" id="inputUserName" placeholder="ID Line" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="inputUserName" class="col-sm-4 control-label">Linkedin</label>
                            <div class="col-sm-7">
                                <input type="text" name="xlinkedin" value="<?php echo $linkedin;?>" class="form-control" id="inputUserName" placeholder="ID Linkedin" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="text" name="xpesan" value="<?php echo $pesan;?>" class="form-control" id="inputUserName" placeholder="Pesan dan Kesan" required>
                            </div>
                        </div>
