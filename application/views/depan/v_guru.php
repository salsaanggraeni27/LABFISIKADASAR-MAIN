...
<head>
    ...
    <title>Lab. Fisika Dasar Itenas - Asisten</title>
            ...
            <?php foreach ($data->result() as $row) :
                ...
                <div class="col-xs-12 col-sm-6 col-md-3 ">
                    <div class="admission_insruction ">
                        ...
                        <?php endif;?>
                        <p class="text-center mt-3 "><span class="bingkai col-sm-2 col-sm-4"><?php echo $row->guru_nama;?></span>
                            <br>
                            <br>
                            <a href="<?= base_url('asisten/detail_data/') . $row->guru_id; ?>" class="btn btn-info"><span class="fa fa-search"></span></a>
                            <a href="<?php echo $row->guru_wa;?>" class="btn btn-success"><i class="fa fa-whatsapp" aria-hidden="true"></i></a>
                            <a href="<?php echo $row->guru_email;?>" class="btn btn-danger"><i class="fa fa-google-plus" aria-hidden="true"></i></a>
