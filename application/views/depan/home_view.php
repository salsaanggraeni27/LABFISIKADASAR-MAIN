...
<head>
    ...
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
        <link href="<?php echo base_url().'theme/js/particles.js-master/demo/css/style.css'?>" rel="stylesheet">
    <link href="<?php echo base_url().'theme/css/style.css'?>" rel="stylesheet">
    <link rel="shortcut icon" href="<?php echo base_url('tema/images/'.$icon);?>">
...
<div class="page-loader">
    ...
    <div id="particles-js">
        <a href="<?php echo site_url('home');?>" class="btn btn-default home-logo">Home
        </a>
