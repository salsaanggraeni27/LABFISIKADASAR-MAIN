...
<head>
    ...
    <title>Lab. Fisika Dasar Itenas - Detail Data Asisten</title>
            ...
            <div class="col-xs-6 col-sm-8 col-md-9">
                <div class="header-top_address">
                    <div class="header-top_list">
                        Halaman Detail Asisten Laboratorium Fisika Dasar Itenas 2021/2022
                    </div>
                </div>
            </div>
...
<section class="our-teachers">
    <div class="container">
        ...
        <div class="row">
                <div class="content">
                    <table class="table tabel" border="1" width="100%" cellpadding="1" cellspacing="1">
                        <tr>
                            <td width="20%">Nama Lengkap</td>
                            <td width="1%">:</td>
                            <td><?php echo $detail->guru_nama; ?></td>
                        </tr>
                        <tr>
                            <td width="20%">NRP</td>
                            <td width="1%">:</td>
                            <td><?php echo $detail->guru_nip; ?></td>
                        </tr>
                        <tr>
                            <td width="20%">Jurusan</td>
                            <td width="1%">:</td>
                            <td><?php echo $detail->guru_jurusan; ?></td>
                        </tr>
                        <tr>
                            <td width="20%">No. HP</td>
                            <td width="1%">:</td>
                            <td><?php echo $detail->guru_hp; ?></td>
                        </tr>
                        <tr>
                            <td width="20%">Email</td>
                            <td width="1%">:</td>
                            <td><?php echo $detail->guru_mail; ?></td>
                        </tr>
                        <tr>
                            <td width="20%">Angkatan</td>
                            <td width="1%">:</td>
                            <td><?php echo $detail->guru_angkatan; ?></td>
                        </tr>
                        <tr>
                            <td width="20%">Status</td>
                            <td width="1%">:</td>
                            <td><?php echo $detail->guru_status; ?></td>
                        </tr>
                    </table>
                </div>
        </div>
