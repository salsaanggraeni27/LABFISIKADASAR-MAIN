...
<head>
    ...
    <title>Lab. Fisika Dasar Itenas - About</title>
                ...
                <nav class="navbar navbar2 navbar-toggleable-md navbar-light bg-faded">
                    ...
                    <div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo site_url('about');?>"><i class="fa fa-info-circle" aria-hidden="true"></i> About</a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo site_url('blog');?>"><i class="fa fa-rss-square" aria-hidden="true"></i>  Blog</a>
                            </li>
                            <li class="nav-item">
...
<section class="welcome_about">
    <div class="container">
        <div class="row">
            <div class="col-md-7">
                <h2>Kata Sambutan</h2>
                <p>Laboratorium Fisika Dasar merupakan bagian penting di ITENAS. Laboratorium Fisika Dasar ITENAS merupakan salah satu laboratorium layanan yang menyelenggarakan
                    kegiatan praktikum berkaitan dengan ilmu dasar fisika. Laboratorium ini dikelola oleh kepala laboratorium yang juga dosen Fisika  dan dibantu tenaga laboran.
                    Secara administratif Laboratorium Fisika Dasar berada dibawah Departemen Fisika ITENAS, laboratorium ini mempunyai tugas utama sebagai penyelenggara Tahap
                    Persiapan Bersama bekerjasama dengan LTPB  (Lembaga Tahap Persiapan Bersama) ITENAS
                </p>
                <p>
                    Laboratorium Fisika Dasar menyelenggarakan kegiatan  praktikum Fisika Dasar bagi mahasiswa semester I dan II program Tahap Persiapan Bersama di ITENAS.
                    Sampai saat ini kami melayani hampir semua fakultas yang ada di ITENAS. Setiap tahunya kami melayani hampir 3400 orang mahasiswa yang terbagi dari semua fakultas.
                </p>
                <p>Laboratorium Fisika Dasar berfokus pada penerapan dasar-dasar dari ilmu fisika yang diharapkan dapat menjadi bekal dan pondasi keilmuan yang utama bagi
                    seluruh mahasiswa yang mengikuti praktikum di Laboratorium Fisika Dasar.
                </p>
                <br>
                <h2>Visi</h2>
                <p>Merupakan Laboratorium yang memberi dukungan bagi perkembangan ilmu pengetahuan melalui penguasaan ilmu Fisika Dasar.</p>
                <br>
                <h2>Misi</h2>
                <p>Mengacu pada ketentuan yang berlaku di itenas, misi laboratorium Fisika Dasar  Itenas adalah sebagai berikut : </p>
                <p>
                    - Memberikan pelayanan terbaik bagi pelaksanaan praktikum oleh pihak pengajar
                </p>
                <p>                    - Mendukung kegiatan penelitian yang memerlukan dukungan sarana yang terkait dengan Fisika Dasar.
                </p>
                <p>                    - Memberi dukungan terkait dengan akreditasi program studi yang memerlukan dukungan laboratorium Fisika Dasar.
                </p>
            </div>
            <div class="col-md-5">
            ...
            <div class="col-md-12">
                <div class="single-item">
                    <div class="quote">
                        ...
                        <p class="quote_text">lab. fisika dasar the best , pengajarnya berkualitas , dan terstuktur dalam pengajarannya</p>
                        <div class="testi-img_block">
                            <img src="<?php echo base_url().'theme/images/haekal.png'?>" class="img-fluid" alt="#">
                            <p><span>Fikri Haekal</span>Koordinator Divisi Media Informasi 2021/2022</p>
                        </div>
                    </div>
                    <div class="quote">
                        <i class="fa fa-quote-left" aria-hidden="true"></i>
                        <p class="quote_text">mantap, salah satu lab yang terbaik , mempunyai banyak fasilitas komunikasi yang lengkap. </p>
                        <div class="testi-img_block">
                            <img src="<?php echo base_url().'theme/images/yanper.png'?>" class="im  g-fluid" alt="#">
                            <p><span>Yan Verdy Tarigan</span>Koordinator Divisi Kaderisasi 2021/2022</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="sitemap">
                    <h3>Akademik</h3>
                    <ul>
                        <li><a href="<?php echo site_url('asisten');?>">Asisten</a></li>
                        <li><a href="<?php echo site_url('kelprak');?>">Praktikan </a></li>
