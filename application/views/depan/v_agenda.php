...
<head>
    ...
    <title>Lab. Fisika Dasar Itenas - Agenda</title>
            ...
            <div class="col-xs-6 col-sm-8 col-md-9">
                <div class="header-top_address">
                    <div class="header-top_list">
                        Halaman Agenda Praktikum Fisika Dasar Itenas
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="peminjaman-hero-card">
                    <span class="hero-badge"><i class="fa fa-calendar"></i> Agenda Kegiatan</span>
                    <h2>Agenda Praktikum</h2>
                    <p>Jadwal dan agenda kegiatan Laboratorium Fisika Dasar ITENAS.</p>
                </div>
            </div>
        </div>
        <br>
